...
using MediatR;
using KatyaKatya.Application.Profile.Commands.ChangePassword;
using KatyaKatya.Application.Profile.Commands.ChangeUsername;
using KatyaKatya.Application.Profile.Commands.UpdateAvatar;
using KatyaKatya.Application.Profile.Commands.UpdatePersonalInfo;
using KatyaKatya.Application.Profile.Queries.GetProfileQuery;
using KatyaKatya.Application.Profile.Queries.GetUserAvatarQuery;
