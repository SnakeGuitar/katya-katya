...
using MediatR;
using KatyaKatya.Application.Social.Commands.AddSocialNetwork;
using KatyaKatya.Application.Social.Commands.AnswerFriendRequest;
using KatyaKatya.Application.Social.Commands.RemoveFriend;
using KatyaKatya.Application.Social.Commands.RemoveSocialNetwork;
using KatyaKatya.Application.Social.Commands.SendFriendRequest;
using KatyaKatya.Application.Social.Queries.GetFriendsListQuery;
using KatyaKatya.Application.Social.Queries.GetPendingFriendRequestsQuery;
using KatyaKatya.Application.Social.Queries.GetSocialNetworksQuery;
