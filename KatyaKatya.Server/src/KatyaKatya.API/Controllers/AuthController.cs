...
using MediatR;
using KatyaKatya.Application.Auth.Commands.FinalizeRegistration;
using KatyaKatya.Application.Auth.Commands.Login;
using KatyaKatya.Application.Auth.Commands.LoginAsGuest;
using KatyaKatya.Application.Auth.Commands.Logout;
using KatyaKatya.Application.Auth.Commands.RefreshSession;
using KatyaKatya.Application.Auth.Commands.Register;
using KatyaKatya.Application.Auth.Commands.ResendVerification;
using KatyaKatya.Application.Auth.Commands.UpgradeGuest;
using KatyaKatya.Application.Auth.Commands.VerifyGuestUpgrade;
using KatyaKatya.Application.Auth.Commands.VerifyRegistration;
using KatyaKatya.Application.Auth.Queries.GetUserByIdQuery;
using KatyaKatya.Application.Auth.Queries.GetUserByUsernameQuery;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace KatyaKatya.API.Controllers;
