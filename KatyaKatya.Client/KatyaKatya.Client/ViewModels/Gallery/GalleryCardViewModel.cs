...
namespace KatyaKatya.ViewModels.Gallery;
...
/// <param name="ImagePath">avares relative path to the image resource.</param>
...
/// through them on each CycleCommand invocation.
/// </summary>
public partial class GalleryCardViewModel : ObservableObject
{
    ...
    /// <summary>Maximum render width for the sticker image.</summary>
